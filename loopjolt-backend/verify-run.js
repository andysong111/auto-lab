...
function verifyRun(run,body,orbit,arcade,challengers,descent){
 ...
 if(run.game==='gyro-drop'&&descent&&run.version===descent.VERSION)return descent.replay(Number(run.seed),body.actions,body.ticks);
