-- Additive upgrade. Preserve every v1 score and accept in-flight v1 replays.
-- Activation is a separate, explicit transaction after UI/API verification.
insert into loopjolt.ranked_games(game,version,title,active,display_order)
values('gyro-drop','gd-descent-v2','Gyro Drop · Deep Descent',false,5)
