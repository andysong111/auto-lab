...
function enter(e){const t=target(e);if(!t||e.defaultPrevented||e.button!==0||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||t.a.hasAttribute('download')||(t.a.target&&t.a.target!=='_self')||t.a.getAttribute('aria-disabled')==='true')return;
 t.u.searchParams.set('play','1');e.preventDefault();location.assign(t.u.pathname+t.u.search+t.u.hash);
}
