...
window.LoopCommunity={api,config,me,logout,googleButton,flag,countries,flagImage,renderFlagLabel,selectionPreview,countryName,get authenticated(){return !!token;},get profile(){return profile;},endpoint:ENDPOINT};
})();
