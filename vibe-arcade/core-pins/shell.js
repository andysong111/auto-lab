...
function create(onAction){
 ...
 shell.text({title:'Core Pins',tag:'One tap. One clean angle.',healthLabel:'SHIELDS',instructions:'Tap or press Space to fire a pin into the rotating core. Never hit a pin or red seal already on the core. Clear each ring and survive the boss stages.'});if(!document.body.dataset.game)document.title='Core Pins — LoopJolt';
