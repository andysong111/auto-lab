...
return (ctx,s,size)=>{const st=s.state,key=st.stage+':'+st.mask;
 ...
 ctx.font='bold 17px sans-serif';ctx.textAlign='center';ctx.fillStyle='#e9f2f7';ctx.fillText('TARGET · light the matching squares',175,30);if(defects.includes('BAD_TEXT'))ctx.fillText('Unreadable overlapping label',175,30);
